...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        lblUName = new JLabel("Kullanýcý Adý");
        lblPasswd = new JLabel("Þifre");
        txtUName = new JTextField();
        txtPasswd = new JPasswordField();
        btnLogin = new JButton("Giriþ", new ImageIcon(ClassLoader.getSystemResource("gameview/login.png")));
        btnCancel = new JButton("Çýkýþ", new ImageIcon(ClassLoader.getSystemResource("gameview/cancel.png")));
